...
function init() {
  ...
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      ...
      document.querySelector('#send-tweet').addEventListener('click', utils.sendTweet, false);
    } else {
      router.navigate('/');
